...
Creating db dataset with all the raw data

```{r}
db <- read_excel("/Users/sarabusatto/Desktop/Rstudio_MosesLab_SB_Raw numbers_08.17.23.xlsx", sheet = "23030809_MosesLab_SB")
...
\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~\~ Dataset (sb) wo outlier

```{r}
#Database (Db)
sb <- read_excel("/Users/sarabusatto/Desktop/Rstudio_MosesLab_SB_Raw numbers_08.17.23.xlsx")
...
sb3 <- read_excel("/Users/sarabusatto/Desktop/Rstudio_MosesLab_SB_Raw numbers_08.17.23.xlsx")
